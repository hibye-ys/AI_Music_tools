...
def parse_arguments():
    ...
    batch_infer_parser.add_argument("--pth_file", type=str, help="Path to the .pth file")
    batch_infer_parser.add_argument(
        "--index_path",
        type=str,
        help="Path to the .index file",
    ...
    train_parser.add_argument("--save_every_epoch", type=str, help="Save every epoch", choices=range(1, 101))
    train_parser.add_argument(
        "--save_only_latest",
        type=str,
    ...
    train_parser.add_argument("--total_epoch", type=str, help="Total epoch", choices=range(1, 1001))
    train_parser.add_argument(
        "--sampling_rate",
        type=str,
        help="Sampling rate (32000, 40000, or 48000)",
