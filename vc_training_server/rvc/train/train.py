...
from data_utils import TextAudioCollate
from data_utils import TextAudioCollateMultiNSFsid
...
if hps.version == "v1":
    ...
    from rvc.lib.infer_pack.models import SynthesizerTrnMs256NSFsid_nono as RVC_Model_nof0
elif hps.version == "v2":
    from rvc.lib.infer_pack.models import MultiPeriodDiscriminatorV2 as MultiPeriodDiscriminator
    from rvc.lib.infer_pack.models import SynthesizerTrnMs768NSFsid as RVC_Model_f0
    from rvc.lib.infer_pack.models import SynthesizerTrnMs768NSFsid_nono as RVC_Model_nof0
