...
def validate_sampling_rate(value):
    ...
    if value in valid_sampling:
        ...
        raise argparse.ArgumentTypeError(f"Invalid sampling_rate. Please choose from {valid_sampling} not {value}")
...
def validate_true_false(value):
    ...
    if value in valid_tf:
        ...
        raise argparse.ArgumentTypeError(f"Invalid true_false. Please choose from {valid_tf} not {value}")
...
def validate_f0method(value):
    ...
    if value in valid_f0methods:
        ...
        raise argparse.ArgumentTypeError(f"Invalid f0method. Please choose from {valid_f0methods} not {value}")
...
def validate_tts_voices(value):
    ...
    if value in short_names:
        ...
        raise argparse.ArgumentTypeError(f"Invalid voice. Please choose from {short_names} not {value}")
